    ...
    'htmlOptions' =>array('class' => 'my-grid-view'),
	 'columns'=>array(
        // 'id',
         ...
         array(
             'name' => 'source',
             'value' => 'isset($data->srcmsg) ? $data->srcmsg->message : ""',
         ),
         array(
             'name' => 'cat',
             'value' => 'isset($data->srcmsg) ? $data->srcmsg->category : ""',
         ),
         'translation',
		array(
            'class'=>'CButtonColumn',
            ...
            (
                ...
                'update' => array(
                    'url'=>'Yii::app()->controller->createUrl("update",array("id"=>$data->id, "lang"=>$data->language))',
                ),
            ),
		),
	),
