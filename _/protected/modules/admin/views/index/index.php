		...
		<div class="tab-content default-tab">
			...
			<table>
				<tr>
                    ...
                    <td><?php echo Yii::app()->format->number( Member::model()->count() ); ?></td>
                </tr>
				<tr>
					<td><?php echo Yii::t('adminindex', 'Newsletter Signups'); ?></td>

                    <td><?php
                        echo Yii::app()->format->number( Newsletter::model()->count() ); ?></td>
                </tr>
				<tr>
					<td><?php echo Yii::t('adminindex', 'Last Registered'); ?></td>
					<td><?php echo Member::model()->find(array('order'=>'date_created desc', 'limit'=>1))->getProfileLink(); ?></td>
				</tr>
				</tr>
            </table>
    ...
    <div class="content-box-content">
        ...
        <div class="tab-content default-tab">
            ...
            <table>
                ...
                <tr>
                     <td><?php echo Yii::t('adminindex', 'Total News'); ?></td>
                    <td><?php echo Yii::app()->format->number( Yii::app()->db->createCommand('SELECT COUNT(id) as total FROM {{contactus}} where sread = 0')->queryScalar() ); ?></td>
                </tr>
            </table>
