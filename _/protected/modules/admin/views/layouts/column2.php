	...
	<body>
		...
		<div id="sidebar">
			...
			<div id="profile-links">
				<?php echo Yii::t('adminglobal', 'Hello,'); ?> <a href="<?php echo $this->createUrl('Member/edituser', array('id'=>intval(Yii::app()->user->id))); ?>" title="<?php echo Yii::t('adminglobal', 'Edit your profile'); ?>"><?php echo urldecode(Yii::app()->user->name); ?></a>, <?php echo Yii::t('adminglobal', 'You have'); ?> <a href="#messages" rel="modal" title="<?php echo Yii::t('adminglobal', '{n} Messages', array('{n}'=>0)); ?>"><?php echo Yii::t('adminglobal', '{n} Messages', array('{n}'=>0)); ?></a><br />
				<br />
		...
		<div id="main-content"> <!-- Main Content Section with everything -->
			...
			<div id="footer"><small><?php echo Yii::t('adminglobal', '{sitename} &copy; {year}  All rights reserved.', array('{year}' => date("Y"), '{sitename}' => Yii::app()->name )); ?></small></div><!-- End #footer -->
