...
<?php $this->widget('zii.widgets.grid.CGridView', array(
    ...
    'htmlOptions' =>array('class' => 'my-grid-view'),
	 'columns'=>array(
         ...
         array(
             'name' => 'name',
             'value' => array($this,'renderNameCol'),
             'type' => 'raw',
         ),
         'desc',
         'index_id',
         ...
         array(
             'header' => 'index_id',
             'name' => 'index_id',
             'class' => 'system.web.my.ext.OrderColumn.OrderColumn',
         ),
         */
         //'is_removed',
		array(
            'class'=>'CButtonColumn',
            'template' => $model->multiImages ? '{images} {update} {delete}' : '{create} {update} {delete}',
            'buttons'=>array
            (
                'images' => array
                (
                ...
                'create' => array
                (
                    'label'=>Yii::t('gl','הוספת עמוד לתפריט'),
                    'imageUrl'=>Yii::app()->controller->image .'/icons/add.png',
                    'url'=>'Yii::app()->controller->createUrl("/admin/menupage/create", array("menu_id"=>$data->primaryKey))',
                ),
            ),
		),
	),
