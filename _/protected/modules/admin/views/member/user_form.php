<div class="content-box"><!-- Start Content Box -->
	...
	<div class="content-box-content">
		...
		<?php
        $model->username = urldecode($model->username);
        echo CHtml::form(); ?>
		
		<?php echo CHtml::label(Yii::t('adminMember', 'Username'), ''); ?>
		...
		<?php echo CHtml::label(Yii::t('adminMember', 'Email Address'), ''); ?>
		...
		<?php echo CHtml::label(Yii::t('adminMember', 'Password'), ''); ?>
		...
		<?php echo CHtml::label(Yii::t('adminMember', 'Default Role'), ''); ?>
		...
		<?php echo CHtml::label(Yii::t('adminMember', 'Other Assigned Roles'), ''); ?>
		...
		<?php echo CHtml::label(Yii::t('adminMember', 'Other Assigned Tasks'), ''); ?>
		...
		<?php echo CHtml::label(Yii::t('adminMember', 'Other Assigned Operations'), ''); ?>
